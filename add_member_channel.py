...
async def main(param_client, param_link_souces):
    ...
    task3 = asyncio.create_task(client_channel_souces(param_client, param_link_souces))
...
# add_member_channel('config_en.json', 't.me/lvxforex1')
# add_member_channel('config_vn.json', 't.me/SkyGroupFreeSignals')

add_member_channel('config.json', 't.me/lvxforex1')
